            ...
            <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                ...
                <div class="max-w-7xl mx-auto p-6 lg:p-8">
                    ...
                    <div class="text-center mt-4">
                        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">LaraInvest Portfolio</h1>
                        <p class="mt-2 text-gray-700 dark:text-gray-400">Manage your investment portfolio with ease using Laravel-powered tools.</p>
                        <div class="mt-4">
                            <Link :href="route('dashboard')" class="inline-block px-4 py-2 text-white bg-red-500 rounded hover:bg-red-600 focus:outline-none focus:ring focus:ring-red-300">Get Started</Link>
                        </div>
                    </div>
                </div>
            </div>
